		...
		<div class="page-wrapper">
            ...
            <div class="page-title-box">
                ...
                <div class="page-title-right">
                    ...
                    <button type="button"  class="btn btn-primary position-absolute top-0 end-0" data-bs-toggle="modal" data-bs-target="#addFoodModal"><i class="lni lni-plus"></i>New Product</button>
                    </div>
...
<script>
    ...
    $.ajax({
        ...
        success: function(response) {
          ...
          $('#edit_food_name').val(response.food_name);
...
$("#editFoodForm").on("submit", function (e) {
    ...
    $.ajax({
        ...
        success: function (response) {
            $(".btn-primary").prop("disabled", false).text("Update Food");
