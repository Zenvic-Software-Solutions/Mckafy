        ...
        <div class="modal-content">
            ...
            <div class="card-body p-4">
                <form class="row g-3 needs-validation" id="editFoodForm" enctype="multipart/form-data" novalidate>
                    <input type="hidden" name="food_id" id="edit_food_id"> <!-- Hidden field for food ID -->

                    <!-- Food Name -->
                    <div class="col-md-6">
                        <label for="edit_food_name" class="form-label">Food Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="food_name" id="edit_food_name" placeholder="Enter Food Name" required />
                        <div class="invalid-feedback">Please enter a food name.</div>
                    </div>
